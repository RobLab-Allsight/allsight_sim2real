...
class DiffCycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            self.sim_regressor = networks.define_regressor('./checkpoints/regression_models/white/real_8_ref.pth', self.gpu_ids)
            self.real_regressor = networks.define_regressor('./checkpoints/regression_models/white/sim_8_ref.pth', self.gpu_ids)
