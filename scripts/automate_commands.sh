...
python3 test.py --dataroot ./datasets/data_Allsight/ --name allsight_distil_27 --model distil_cycle_gan

# Create JSON for GAN Images
python3 data_process/sim2gan_json.py --sim_data_num 7 --cgan_num 27 --name allsight_distil_27 --data_kind transformed --cgan_epoch latest --save True

# Train and Test - Regressor
python3 train_regressor.py --train_type gan --sim_data_num 7 --real_data_num 7 --cgan_num 27 --gan_name distil_cgan --cgan_epoch latest --leds white --aug True
