...
sim_paths = [f"./datasets/data_Allsight/all_data/allsight_sim_dataset/{gel}/{leds}/data/{ind}" for ind in indenter]
...
df_data_real['frame'] = df_data_real['frame'].str.replace("/home/osher/catkin_ws/src/allsight/dataset/", "./datasets/data_Allsight/all_data/allsight_dataset/")
df_data_real['frame'] = df_data_real['frame'].str.replace("/20","/sphere3")
...
for i in range(100):
    ...
    sim_image = (cv2.imread("./datasets/data_Allsight/all_data/"+df_data_sim['frame'][sample])).astype(np.uint8)
